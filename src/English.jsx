        ...
        <>
          ...
          <div className='duha-grad'>
            <div className='text-justify mx-4 lg:mx-8 text-[22.5px]  py-8 intro'>
              ...
              <p className='mt-4'>
                Lord Jesus was a friend of sinners and tax collectors and that
              ...
              <p className='mt-4'>
                I personally know several homosexuals and they are friendly
                people. They are talented and polite to others. They are
              ...
              <p className='mt-4'>
                If you work hard, protect nature, do charity, but do not believe
                in Jesus, you are condemned if you remain in this disbelief.
                People drowned during the flood, not because they were all
                maladjusted individuals, but because they did not believe Noah
                and did not enter the ark. Friendly, talented, decent, empathic,
                and sociable people drowned as well.
              </p>
              ...
              <p>
                But Jesus died for the sins of all, and whoever believes in Him
              ...
              <p>
                God's Word often touches on the issue of extramarital
                relationship.
                <span className='italic'>
                  {' '}
                  Flee from sexual immorality. Every other sin a man can commit
                  is outside his body, but he who sins sexually sins against his
                  own body.{' '}
                </span>
              ...
              <p className='mt-4'>
                Would same-sex marriage solve this problem? God's Word also
                mentions homosexual relationships in some places.
                <span className='italic'>
                  {' '}
                  For this reason God gave them over to dishonorable passions.
                  Even their women exchanged natural relations for unnatural
                  ones. Likewise, the men abandoned natural relations with women
                  and burned with lust for one another. Men committed indecent
                  acts with other men, and received in themselves the due
                  penalty for their error. Furthermore, since they did not see
                  fit to acknowledge God, He gave them up to a depraved mind, to
                ...
                <span className='italic'>
                  ...
                  such things are worthy of death, they not only continue to do
                  these things, but also approve of those who practice them.{' '}
                </span>
                <span className='text-[15px]'> Romans 1:32 </span>
              </p>
              <p className='mt-4'>
                Whether you live in a non-marital heteronormative relationship
                or a same-sex relationship (the decisive gender is natural at
                birth, not after a sex-change operation), God's Word puts them
                on the same level.
                <span className='italic'>
                  {' '}
                  Do not be deceived: Neither the sexually immoral, nor
                  idolaters, nor adulterers, nor men who submit to or perform
                  homosexual acts, nor thieves, nor the greedy, nor drunkards,
                  nor verbal abusers, nor swindlers, will inherit the kingdom of
                  God.{' '}
                </span>
              ...
              <p className='mt-4'>
                Are we who we feel or are we who we were born? Do you feel like
                the president? You are not. Do you feel like a monkey? You are
                not. Do you feel like a plant? You are not. Do you feel like you
                are the opposite sex? You are not.
              </p>

              <p className='mt-4'>
                Feelings and thoughts are often misleading because they are
                distorted by sin. Sometimes you like it, other times you're
                unhappy.
              </p>
              ...
              <p className='mt-4'>
                If you were born a boy, you are a man. If you were born a girl,
                you are a woman. Then it was the Creator's will that you be what
                you are from birth. And that's because He has good intentions
                with you. So why go against the will of the Most High?
              </p>
              ...
              <p>
                ...
                <span className='italic'>
                  {' '}
                  For the flesh craves what is contrary to the Spirit, and the
                  Spirit what is contrary to the flesh. They are opposed to each
              ...
              <p>
                Your soul is precious, do not remain in satan's seduction. Don't
                close your eyes to it. By trying not to believe in it, you will
                not cause it to perish. Even Neo in the Matrix was faced with a
                choice. Blue or red? Merciful illusion or hard reality?
              </p>
              <p className='mt-4'>
