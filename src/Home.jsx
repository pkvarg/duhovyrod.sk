            ...
            <div className='text-justify mx-4 lg:mx-8 text-[18px] mt-20 py-8 intro'>
              ...
              <p>
                ...
                <span className='italic'>
                  {' '}
                  On je obeťou zmierenia za naše hriechy, a nielen za naše, ale
                  aj za hriechy celého sveta.{' '}
                </span>
              ...
              <p className='mt-4'>
                Pán Ježiš bol priateľ hriešnikov a colníkov a preto Ho vtedajší
                kňazi odsudzovali.
                <span className='italic'>
                  {' '}
              ...
              <p>
                ...
                <span className='italic'>
                  {' '}
                  Lebo to je láska k Bohu, aby sme zachovávali Jeho prikázania;
              ...
              <p className='mt-4'>
                ...
                neveríš v Ježiša, si odsúdený, ak v tejto nevere zostaneš. Ľudia
                sa počas potopy utopili nie preto, že by boli všetci
                neprispôsobivé individuá, ale preto, že neuverili Noachovi a
                nevstúpili do korábu. Utopili sa aj priateľskí, aj talentovaní,
                aj slušní, aj empatickí, aj spoločenskí.
              </p>
              ...
              <p>
                ...
                človek po tom ako uveril v Ježiša, má túžbu a snahu opustiť
                hriech a jeho otroctvo.
                <span className='italic'>
                  {' '}
                  Kto však neposlúcha Syna, neuvidí život, ale hnev Boží zostáva
                  na ňom.{' '}
                </span>
              ...
              <p className='mt-4'>
                ...
                <span className='italic'>
                  ...
                  zamenili prirodzený styk s mužmi za protiprirodzený, a podobne
                  aj mužovia zanechali prirodzený styk so ženou a rozpálili sa
                  vášňou medzi sebou: mužovia s mužmi páchali hanebnosť a za
                  svoje poblúdenie sami na sebe niesli odplatu, akú si
                  zaslúžili. A keďže nepokladali za hodné zachovať si poznanie
                  Boha, vydal ich Boh prevrátenému zmýšľaniu, aby páchali, čo sa
                  nesluší: naplnení všetkou neprávosťou smilstvom.{' '}
                </span>
                <span className='text-[15px]'> Rimanom 1:26-29</span>
                <span className='italic'>
                  {' '}
                  Poznali síce právny poriadok Boží, že tí, čo pášu takéto veci,
                  zasluhujú si smrť, a predsa nielen sami ich robia, ale aj
                  schvaľujú, keď ich pášu iní.{' '}
                </span>
                <span className='text-[15px]'> Rimanom 1:32 </span>
              </p>
              <p className='mt-4'>
                Či žiješ v nemanželskom heterosexuálnom vzťahu alebo vo vzťahu s
                rovnakým pohlavím (rozhodujúce pohlavie je to prirodzené pri
                ...
                <span className='italic'>
                  ...
                  lakomci, ani opilci, ani rúhači, ani vydierači nebudú dedičmi
                  kráľovstva Božieho!{' '}
                </span>
              ...
              <p className='mt-4'>
                ...
                dievča, si žena. Potom to bola vôľa Stvoriteľa, aby si bol/bola
                tým, čím si od narodenia. A to preto, lebo s tebou má dobrý
                úmysel. Tak prečo ísť proti vôli Najvyššieho?
              </p>
              ...
              <p>
                ...
                Čím viac budeš posilňovať svojho ducha, tým bude slabšie telo a
                to vypôsobí, že doterajšia žiadostivosť k hriechu bude slabnúť.
                Nejde o telo samotné, ale o toho zlého, ktorý ho má v područí.
                <span className='italic'>
                  {' '}
                  Veď náš boj nie je proti krvi a telu, ale proti kniežatstvám a
                  mocnostiam, proti pánom sveta tejto temnosti, proti zlým
                  duchom v nebesiach.{' '}
                </span>
                ...
                v tvojom živote môže zviazať ten, koho Pánom je Ježiš, kto nesie
                Jeho autoritu. Sám som túto autoritu uplatňoval vo svojom živote
                - v rôznych oblastiach
                <span className='text-[15px]'>
                  {' '}
                  (človek môže byť v neslobode v akejkoľvek oblasti života ako
                  je aj prílišná spotreba, otrocké nasledovanie módnych trendov,
